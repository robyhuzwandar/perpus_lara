...
<div class="wrapper">
  ...
  <?php echo $__env->make('template.leftside', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(url('/assets/dist/js/pages/dashboard2.js')); ?>"></script>
